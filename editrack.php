...
$sql="select * from rack where rackid='$rid'";
...
if(isset($_POST['send']))
{
   ...
   $sql="update rack SET name='$urname',status='$ustatus' where rackid='$rid'";
   $res=mysqli_query($conn,$sql);
    if($res)
    {
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="rack.php">
    ...
    <table>
        <tr>
            <td class="color"> <label for="rname">Rack Name:</label>  </td>
            <td> <input type="text" class="form-control" name="rname" value="<?php echo $data['name'];?>"  id="rname"   required/> </td>
        </tr>
