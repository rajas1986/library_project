...
$sql="select * from category where categoryid='$rid'";
...
if(isset($_POST['send']))
{
   ...
   $sql="update book SET category_name='$ucname',status='$ustatus' where categoryid='$rid'";
   $res=mysqli_query($conn,$sql);
   echo $res;
   exit;
   if($res)
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <table>
        <tr>
            ...
            <td> <input type="text" class="form-control" name="cname" value="<?php echo $data['category_name'];?>"  id="cname"   required/> </td>
        </tr>
