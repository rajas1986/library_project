...
if(isset($_POST['send']))
{
    ...
    $rdt=$_POST['rdt'];
    $status=$_POST['status'];
    $sql="insert into issued_book(bookid,uid,expected_return_date,return_date_time,status)values('$bname','$uname','$edt','$rdt','$status')";
    $res=mysqli_query($conn,$sql);  
    if($res)
    {
        echo"<script>window.location.href='issuedbook.php'</script>";
    }
    else{
...
<div class="container">
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">  
      <h1 class="h2">Add Issued Book</h1>
...
<tr>
  ...
  ?>
        ...
        <tr>
            ...
            <td> <input type="date" class="form-control" name="edt" id="edt"/> </td>
        </tr>
  
        <tr>
            <td class="color"> <label for="rdt">Return Date Time</label>  </td>
            <td> <input type="date" class="form-control"  name="rdt"  id="rdt" required  /> </td>
        </tr>
        <tr>
