...
if(isset($_POST['send']))
{
    $rname=$_POST['rname'];
    $status=$_POST['status'];
    $sql="insert into rack(name,status)values('$rname','$status')";
    $res=mysqli_query($conn,$sql);  
    if($res)
    {
        echo"<script>window.location.href='rack.php'</script>";
    }
    else{
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <table>
        <tr>
            ...
            <td> <input type="text" class="form-control" name="rname"   id="rname"   required/> </td>
        </tr>
