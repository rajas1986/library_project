...
$sql="select * from author where authorid='$rid'";
...
if(isset($_POST['send']))
{
    $uarname=$_POST['arname'];
    $ustatus=$_POST['status'];
   $sql="update author SET author_name='$uarname',status='$ustatus' where authorid='$rid'";
   $res=mysqli_query($conn,$sql);
    if($res)
    {
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="author.php">
    ...
    <table>
        <tr>
            <td class="color"> <label for="arname">Author Name:</label>  </td>
            <td> <input type="text" class="form-control" name="arname" value="<?php echo $data['author_name'];?>"  id="arname"   required/> </td>
        </tr>
