...
if(isset($_POST['send']))
{
    $arname=$_POST['arname'];
    $status=$_POST['status'];
    $sql="insert into author(author_name,status)values('$arname','$status')";
    $res=mysqli_query($conn,$sql);  
    if($res)
    {
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <table>
        <tr>
            ...
            <td> <input type="text" class="form-control" name="arname"   id="arname"   required/> </td>
        </tr>
