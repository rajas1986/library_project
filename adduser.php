...
if(isset($_POST['send']))
{
    ...
    $mn=$_POST['mn'];
    $status=$_POST['status'];
    $sql="insert into user(first_name,last_name,date_of_birth,email,password,mobile_no,type)values('$fname','$lname','$db','$uname','$upass','$mn','$type')";
    $res=mysqli_query($conn,$sql);  
    if($res)
    {
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <table>
        ...
        <tr>
            ...
            <td> <input type="email" class="form-control"  name="uname"  id="uname" required  /> </td>
        </tr>
        <tr>
            <td class="color"> <label for="upass">Password</label>  </td>
            <td> <input type="password" class="form-control"  name="upass"  id="upass" required  /> </td>
        </tr>
        <tr>
